<?php $__env->startSection('page-title', $transmittal->transmittal_number); ?>
...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($transmittal->transmittal_number); ?></h1>
                ...
                <div class="p-6">
                    <dl class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <dd class="mt-1 text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($transmittal->transmittal_number); ?></dd>
                        </div>

                        <div>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Date</dt>
                            <dd class="mt-1 text-lg text-gray-900 dark:text-white"><?php echo e($transmittal->date->format('M d, Y')); ?></dd>
                        </div>

                        <div class="sm:col-span-2">
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Vendor Name</dt>
                            <dd class="mt-1 text-lg text-gray-900 dark:text-white"><?php echo e($transmittal->vendor_name); ?></dd>
                        </div>

                        <div class="sm:col-span-2">
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Description</dt>
                            <dd class="mt-1 text-gray-900 dark:text-white"><?php echo e($transmittal->description); ?></dd>
                        </div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-gray-900 dark:text-white">
                                <?php echo e($transmittal->created_at->format('M d, Y \a\t g:i A')); ?>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg card-3d overflow-hidden">
                <div class="bg-gray-50 dark:bg-gray-700 px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                        Transmitted Documents (<?php echo e($transmittal->getDocumentCount()); ?> items)
                    </h3>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                <td class="table-cell text-center"><?php echo e($index + 1); ?></td>
                                <td class="table-cell">
                                ...
                                <td class="table-cell">
                                    <div class="text-gray-900 dark:text-white">
                                        <?php echo e(Str::limit($document->document_title, 40)); ?>
                                ...
                                <td class="table-cell">
                                    <div class="text-gray-900 dark:text-white">
                                        <?php echo e($document->document_position ?: 'N/A'); ?>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($transmittal->getDocumentCount()); ?></span>
                        </div>
                        ...
                        <div class="flex justify-between">
                            <span class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($status); ?>:</span>
                            <span class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($count); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Own Project\document-control2\resources\views/transmittals/show.blade.php ENDPATH**/ ?>