...
<div x-data="{ ...bulkActions(), ...filters() }" class="space-y-6">
        ...
        <div class="mt-4 sm:mt-0 flex flex-col sm:flex-row gap-3">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" @click.away="open = false" x-transition
                    ...
                    <a href="<?php echo e(route('documents.export.excel')); ?>"
                       class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600">
                        Export to Excel
                    </a>
                    <a href="<?php echo e(route('documents.export.pdf')); ?>"
                       class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600">
                        Export to PDF
                    </a>
                </div>
    ...
    <div x-show="showFilters" x-transition class="bg-white dark:bg-gray-800 rounded-lg shadow-sm card-3d p-6">
        <form method="GET" action="<?php echo e(route('documents.index')); ?>" x-ref="filterForm" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input type="text"
                           name="document_title"
                           value="<?php echo e(request('document_title')); ?>"
                ...
                <div>
                    ...
                    <select name="reviewer_id" class="form-select">
                        ...
                        <option value="<?php echo e($reviewer->id); ?>" <?php echo e(request('reviewer_id') == $reviewer->id ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           value="<?php echo e(request('document_position')); ?>"
                ...
                <div>
                    ...
                    <input type="date"
                           ...
                           value="<?php echo e(request('submission_date_from')); ?>"
                           class="form-input">
                </div>
                ...
                <div>
                    ...
                    <input type="date"
                           ...
                           value="<?php echo e(request('submission_date_to')); ?>"
                           class="form-input">
                </div>
                ...
                <div class="flex items-center space-x-3">
                    <input type="checkbox"
                           name="overdue_only"
                           value="1"
                           <?php echo e(request('overdue_only') ? 'checked' : ''); ?>
    ...
    <div x-show="showBulkActions" x-transition class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <form method="POST" action="<?php echo e(route('documents.bulk-update')); ?>" x-data="{ action: 'update_status', status: '', reviewer_id: '' }">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex space-x-2">
                        ...
                        <select x-show="action === 'assign_reviewer'" x-model="reviewer_id" class="form-select text-sm">
                            ...
                            <?php $__currentLoopData = $reviewers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reviewer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($reviewer->id); ?>"><?php echo e($reviewer->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left">
                            <input type="checkbox"
                                   @change="toggleAll([<?php echo e($documents->pluck('id')->implode(',')); ?>])"
                                   :checked="selectedItems.length === <?php echo e($documents->count()); ?> && <?php echo e($documents->count()); ?> > 0"
                                   class="form-checkbox">
                        </th>
                        <?php endif; ?>
                        <th class="table-header">
                            <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'document_number', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])); ?>"
                        ...
                        <th class="table-header">
                            <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'submission_date', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])); ?>"
                               class="group inline-flex items-center">
                                Submission Date
                                <svg class="ml-1 w-4 h-4 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"/>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <input type="checkbox"
                                   @change="toggleItem(<?php echo e($document->id); ?>)"
                                   :checked="isSelected(<?php echo e($document->id); ?>)"
                                   class="form-checkbox">
                        </td>
                        <?php endif; ?>
                        <td class="table-cell">
                        ...
                        <td class="table-cell">
                            <div class="text-gray-900 dark:text-white">
                                <?php echo e(Str::limit($document->document_title, 50)); ?>
                        ...
                        <td class="table-cell">
                            <?php if($document->latestReviewer): ?>
                                <div class="text-gray-900 dark:text-white">
                                    <?php echo e($document->latestReviewer->name); ?>
                        ...
                        <td class="table-cell">
                            <div class="text-gray-900 dark:text-white">
                                <?php echo e($document->document_position ?: 'Not specified'); ?>
                        ...
                        <td class="table-cell">
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="<?php echo e(route('documents.review', $document)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Own Project\document-control2\resources\views/documents/index.blade.php ENDPATH**/ ?>