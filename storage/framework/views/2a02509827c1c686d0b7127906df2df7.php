...
<div class="space-y-6" x-data="notificationManager()">
        ...
        <div class="mt-4 sm:mt-0 flex space-x-3">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" @click.away="open = false" x-transition
                    ...
                    <a href="?filter=all"
                       class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 <?php echo e(request('filter', 'all') === 'all' ? 'bg-gray-100 dark:bg-gray-600' : ''); ?>">
                        All Notifications
                    </a>
                    <a href="?filter=unread"
                       class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 <?php echo e(request('filter') === 'unread' ? 'bg-gray-100 dark:bg-gray-600' : ''); ?>">
                        Unread Only
                    </a>
                    <a href="?filter=review"
                       class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 <?php echo e(request('filter') === 'review' ? 'bg-gray-100 dark:bg-gray-600' : ''); ?>">
                        Review Notifications
                    </a>
                    <a href="?filter=overdue"
                       class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 <?php echo e(request('filter') === 'overdue' ? 'bg-gray-100 dark:bg-gray-600' : ''); ?>">
                        Overdue Alerts
                    </a>
                </div>
            </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($notifications->total()); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white" x-text="unreadCount"><?php echo e($notifications->where('read_at', null)->count()); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($notifications->where('type', 'review')->count()); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($notifications->where('type', 'overdue')->count()); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg card-3d">
        ...
        <div class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div class="p-6 <?php echo e($notification->read_at ? 'opacity-75' : ''); ?> notification-item"
                 data-notification-id="<?php echo e($notification->id); ?>">
                <div class="flex items-start space-x-4">
                    <!-- Icon based on type -->
                    <div class="flex-shrink-0">
                        <div class="w-10 h-10 rounded-full flex items-center justify-center notification-icon-<?php echo e($notification->type); ?>">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <button @click="deleteNotification(<?php echo e($notification->id); ?>)"
...
function notificationManager() {
    return {
        unreadCount: <?php echo e($notifications->where('read_at', null)->count()); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Own Project\document-control2\resources\views/notifications/index.blade.php ENDPATH**/ ?>