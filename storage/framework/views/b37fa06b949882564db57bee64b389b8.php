<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" x-data="theme" :class="{ 'dark': dark }" x-cloak>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">

    <title><?php echo $__env->yieldContent('title', 'Login'); ?> - Document Control System</title>
            ...
            <div class="mx-auto w-full max-w-md">
                ...
                <div class="mt-8 text-center">
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        © <?php echo e(date('Y')); ?> Engineering Document Control System. Professional document management solution.
                    </p>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\My Own Project\document-control2\resources\views/layouts/auth.blade.php ENDPATH**/ ?>