...
<head>
    ...
    <title>Transmittal Letter <?php echo e($transmittal->transmittal_number); ?></title>
    <style>
        @page {
            margin: 2cm;
            margin-top: 3cm;
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            <div class="transmittal-number"><?php echo e($transmittal->transmittal_number); ?></div>
            <div class="transmittal-date"><?php echo e($transmittal->date->format('F d, Y')); ?></div>
        </div>
    </div>
    ...
    <div class="footer">
        ...
        <div>This transmittal letter was generated on <?php echo e(now()->format('F d, Y \a\t g:i A')); ?></div>
    </div>
    ...
    <div class="content">
        ...
        <div class="info-section">
            ...
            <div class="info-content">
                <div class="info-row">
                    ...
                    <div class="info-value"><?php echo e($transmittal->transmittal_number); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">Date:</div>
                    <div class="info-value"><?php echo e($transmittal->date->format('F d, Y')); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">To:</div>
                    <div class="info-value"><?php echo e($transmittal->vendor_name); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">From:</div>
                    <div class="info-value"><?php echo e($transmittal->creator->name); ?> (<?php echo e(ucfirst($transmittal->creator->role)); ?>)</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Subject:</div>
                    <div class="info-value"><?php echo e($transmittal->description); ?></div>
                </div>
            </div>
        </div>
        ...
        <!-- Document List -->
        <div class="info-section">
            <div class="info-header">Transmitted Documents (<?php echo e(count($documents)); ?> items)</div>
            <div class="info-content">
                <table class="documents-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold;"><?php echo e($document->document_number); ?></td>
                            <td><?php echo e($document->document_title); ?></td>
                            <td style="text-align: center;"><?php echo e($document->revision); ?></td>
                            <td>
                            ...
                            <td><?php echo e($document->document_position ?: 'N/A'); ?></td>
                        </tr>
        ...
        <div class="signature-section">
            <div class="signature-box">
                ...
                <div class="signature-line">
                    <?php echo e($transmittal->creator->name); ?><br>
                    <?php echo e(ucfirst(str_replace('_', ' ', $transmittal->creator->role))); ?>
...
<?php /**PATH D:\My Own Project\document-control2\resources\views/transmittals/pdf.blade.php ENDPATH**/ ?>