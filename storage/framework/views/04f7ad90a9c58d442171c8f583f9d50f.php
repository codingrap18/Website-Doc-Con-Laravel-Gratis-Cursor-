<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" x-data="theme" :class="{ 'dark': dark }">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">

    <title><?php echo $__env->yieldContent('title', 'Document Control System'); ?> - Engineering Document Management</title>
        ...
        <div
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                <a href="<?php echo e(route('dashboard')); ?>"
                   class="flex items-center space-x-3 px-3 py-2 text-sm font-medium rounded-lg transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 <?php echo e(request()->routeIs('dashboard') ? 'bg-primary-50 dark:bg-primary-900/40 text-primary-700 dark:text-primary-200 border-r-2 border-primary-500' : ''); ?>">
                ...
                <a href="<?php echo e(route('documents.index')); ?>"
                   class="flex items-center space-x-3 px-3 py-2 text-sm font-medium rounded-lg transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 <?php echo e(request()->routeIs('documents.*') ? 'bg-primary-50 dark:bg-primary-900/40 text-primary-700 dark:text-primary-200 border-r-2 border-primary-500' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('reviews.pending')); ?>"
                   class="flex items-center space-x-3 px-3 py-2 text-sm font-medium rounded-lg transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 <?php echo e(request()->routeIs('reviews.*') ? 'bg-primary-50 dark:bg-primary-900/40 text-primary-700 dark:text-primary-200 border-r-2 border-primary-500' : ''); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('transmittals.index')); ?>"
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open"
                                ...
                                <div class="w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center">
                                    <span class="text-white font-medium"><?php echo e(substr(auth()->user()->name, 0, 1)); ?></span>
                                </div>
                                <span class="hidden md:block text-gray-700 dark:text-gray-300"><?php echo e(auth()->user()->name); ?></span>
...
<?php /**PATH D:\My Own Project\document-control2\resources\views/layouts/app.blade.php ENDPATH**/ ?>