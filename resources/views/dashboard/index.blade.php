...
<div class="space-y-6">
        ...
        <div class="p-6 bg-gradient-to-r from-primary-500 to-secondary-500 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-primary-100 mt-1">{{ ucfirst(auth()->user()->role) }} • {{ now()->format('l, F d, Y') }}</p>
                </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $statistics['total_documents'] }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $statistics['pending_reviews'] }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $statistics['overdue_documents'] }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $statistics['completed_this_month'] }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    @if(auth()->user()->isReviewer() && $statistics['my_pending_reviews'] > 0)
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium text-yellow-800 dark:text-yellow-200">
                    You have {{ $statistics['my_pending_reviews'] }} document(s) pending your review
                </h3>
                <div class="mt-2">
                    ...
                    <div class="flex items-start space-x-3">
                        <div class="flex-shrink-0">
                            <div class="w-8 h-8 bg-{{ $activity['color'] }}-100 dark:bg-{{ $activity['color'] }}-900 rounded-full flex items-center justify-center">
                                @if($activity['icon'] === 'document-plus')
            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="border-l-4 border-red-400 pl-3 py-2">
                        <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $document->document_number }}</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400">{{ $document->getDaysOverdue() }} days overdue</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400">{{ $document->latestReviewer?->name ?? 'Unassigned' }}</p>
                    </div>
                    @empty
                ...
                <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                    <a href="{{ route('documents.index', ['overdue_only' => true]) }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const monthlyData = @json($chartData['monthly_submissions']);
